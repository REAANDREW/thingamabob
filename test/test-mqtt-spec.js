...
describe('MQTT Specification v3.1.1', function() {
    ...
    describe('3 - MQTT Control Packets', function() {
        ...
        describe('3.2 CONNACK – Acknowledge connection request', function() {
            describe('3.2.1 Fixed header', function() {
                it('has a remaining length of 2');
            });
            describe('3.2.2 Variable header', function() {
                describe('3.2.2.1 Connect Acknowledge Flags', function() {
                    it('Bits 7-1 are reserved and MUST be set to 0');
                });
                describe('3.2.2.2 Session Present', function() {
                    describe('If the Server accepts a connection with CleanSession set to 1', function(){
                        it('MUST set Session Present to 0 [MQTT-3.2.2-1]');
                    });
                    describe('If the Server accepts a connection with CleanSession set to 1', function(){
                        describe('If the Server has stored Session state', function(){
                            it('MUST set Session Present to 1 in the CONNACK packet [MQTT-3.2.2-2]');
                        });
                        describe('If the Server does not have stored Session state', function(){
                            it('MUST set Session Present to 0 in the CONNACK packet [MQTT-3.2.2-3]');
                        });
                    });
                    describe('If a server sends a CONNACK packet containing a non-zero return code', function(){
                        it('MUST set Session Present to 0 [MQTT-3.2.2-4]');
                    });
                });
                describe('3.2.2.3 Connect Return code', function() {
                    describe('If a server sends a CONNACK packet containing a non-zero return code', function(){
                        it('MUST close the Network Connection [MQTT-3.2.2-5]');
                    });
                    describe('If none of the return codes are deemed applicable', function(){
                        it('MUST close the Network Connection without sending a CONNACK [MQTT-3.2.2-6]');
                    });
                });
            });
