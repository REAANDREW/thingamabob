...
function ConnectMessage(args) {
    ...
    headers = {
      ...
      variable: {
        ...
        connectFlags: {
          ...
          will : defaultValue(connectFlags.will, 0),
          willQos : defaultValue(connectFlags.willQos, 0),
          willRetain : defaultValue(connectFlags.willRetain, 0),
          username : defaultValue(connectFlags.username, 0),
          password : defaultValue(connectFlags.password, 0)
        }
      }
    };
    payload = {
  ...
  function setWillTopic(value){
    headers.variable.connectFlags.will = 1;
    payload.will.topic = value;
  }
